...
let heartRate2D = 78.0
let heartRate3D = 96.0
let addedHRD = heartRate1D + heartRate2D + heartRate3D
let averageHRD = addedHRD / 3
print(averageHRD)
print("they do different because have the heart rate D set to doubles makes the console able to print the numbers to decimal places, rather than keep an integer")
/*:
